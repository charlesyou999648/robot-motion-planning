    ...
    while totalIter <= totalTests
        ...
        while iter < iterLimit
            ...
            if eDecay % is eDecay == True
                epsilon = exp(-eDecayFactor/totalTests * totalIter);
            else
                epsilon = eConst; 
            end
...
save('test4_s5sqaure_analysis_5000','collisionRate', 'reachGoalRate', 'collisionNumberRate', 'meanTravellingTime')
% 
% figure;
% hold on;
...
%     start1 = 400;
%     end1 = 400;
%     h1 = rectangle('position', [0, -10, 30, 20], 'FaceColor', 'b');
%     g1 = hgtransform;
%     set(h1,'Parent',g1)
%     gHuman{end+1} = g1;
%     startpoint1 = [start1 hallwayWeight 0];
%     endpoint1 = [end1 -hallwayWeight 0];
% %     plot([start1+14 end1+14], [-hallwayWeight hallwayWeight], ':', 'Color', 'b','LineWidth',2)
% end
% 
% % define vehicle
